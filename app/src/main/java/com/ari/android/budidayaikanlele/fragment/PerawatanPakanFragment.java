...
public class PerawatanPakanFragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View rootView = inflater.inflate(R.layout.fragment_perawatan_pakan, container, false);
...
//        view.loadData(getString(R.string.kolam), "text/html; charset=utf-8", "utf-8");
        view.loadUrl("file:///android_asset/perawatan.html");
