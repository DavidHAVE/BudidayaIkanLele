...
public class Bulan2Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bulan2, container, false);
    ...
    private void readProgress() {
        ...
        List<Progress> progressesWatchList = db.getAllProgressByPond(pond_id, "Bulan 2");
