...
public class Bulan3Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bulan3, container, false);
    ...
    private void readProgress() {
        ...
        List<Progress> progressesWatchList = db.getAllProgressByPond(pond_id, "Bulan 3");
    ...
    private void saveProgress() {
        ...
        Log.e("saveProgress", beratBibit1+", "+seedAmount+", "+beratPakan1+", "+pond_id+", "+month);
